...
const setCreatePokemonCard = (dadosPokemon) => {
    ...
    img.setAttribute('src', dadosPokemon.sprites.front_shiny || dadosPokemon.sprites.other["official-artwork"].front_shiny);
...
const getDadosPokemonAPI = async (page) => {
    ...
    try {
        ...
        for (let item of data.results) {
            ...
            if (pokemonData.sprites.front_shiny || pokemonData.sprites.other["official-artwork"].front_shiny) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (pokemonData.sprites.front_shiny || pokemonData.sprites.other["official-artwork"].front_shiny) {
                    ...
                    alert("Esse Pokémon não possui uma versão Shiny.");
                }
            } else {
